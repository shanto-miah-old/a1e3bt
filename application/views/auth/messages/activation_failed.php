...
<div class="container">
	<div class="row justify-content-center">
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">Activation Failed!</div>
				<div class="card-body">
					<div class="row">
						<div class="col-md-3 pl-4 pt-2 text-center">
							<div class="display-1 pr-2 text-danger">
								<i class="ion ion-alert-circled"></i>
							</div>
						</div>
						<div class="col-md-9">
							<div class="h5 card-title">Failed!</div>
							<div class="card-text">
								Sorry. Your email varification is failed! Pleace check your email and try again.
								<br><br>
								Thank You.
							</div>
						</div>
