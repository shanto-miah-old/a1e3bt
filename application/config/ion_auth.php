...
$config['tables']['users_updated']  = 'users_updated';
...
$config['admin_email']                = "example@gmail.com"; // Admin Email, admin@example.com
...
/*
* Email configaration is lodded on colfig/email.php.
*/
...
$config['error_start_delimiter']   = '<p><i class="ion-alert-circled"></i> ';		// Error message start delimiter
